...
**Run all tests**:
   ...
   run_tests
   ```
- Currently, tests are written using `pytest` and are located in the `tests/` directory.
- Tests include unit tests for individual functions, integration tests for combined components, and end-to-end tests for the entire ETL process.
- Tests beyond integration extract tests are still being developed, but involve making a true API call to ensure the ETL process works as expected.
- This is intended to be changed to use mocking to avoid making real API calls during testing.
    ...
    User Stories
      ...
      Data (User Story 3:
        As a data engineer, I want to load the transformed data into a local file so that it can be easily accessed for analysis.
          ...
          Task 2: Choose an appropriate file format for the local file.
      ...
      Data (User Story 4:
        As a data engineer, I want to implement extensive testing for the ETL process so that I can ensure data quality and reliability.
          ...
          Task 3: Implement automated testing using a testing framework.
